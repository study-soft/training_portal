                    ...
                    success: function (savedQuestionId) {
                        ...
                        switch (questionType) {
                            case "ONE_ANSWER":
                                ...
                                questionHeader.find("a:contains(Delete)").attr("href", savedQuestionId);
                                ...
                                if (explanation) {
                                    container.append('<div><strong>Explanation: </strong></div>');
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <div id="noQuestionsInfo" class="row no-gutters align-items-center highlight-primary">
                        ...
                        <div class="col">
                            There is no questions for quiz '<c:out value="${quiz.name}"/>'
                        </div>
                    </div>
                </c:otherwise>
            </c:choose>
