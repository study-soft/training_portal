...
public class TeacherQuizController {
    ...
    /**
     * Створення нової вікторини. Проводиться валідація параметрів, введених користувачем.
    ...
    /**
     * Редагування вікторини. Проводиться валідація параметрів, введених користувачем. Якщо валідація успішна -
